...
namespace Entidades
{
    ...
    public class PeliculaComedia : Pelicula
    {
        ...
        #endregion
        /// <summary>
        /// Utiliza la implementación base de Equals y atributos propios (actorPrincipal y tipoComedia) para comparar las instancias.
        /// </summary>
        ...
        {
            if (obj is PeliculaComedia otraPeliComedia)
            {
                return base.Equals(obj) &&
                       this.actorPrincipal == otraPeliComedia.actorPrincipal &&
                       this.tipoComedia == otraPeliComedia.tipoComedia;
            }
            return false;
            //return base.Equals(obj);
        }
